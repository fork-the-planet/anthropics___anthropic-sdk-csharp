...
public class BetaManagedAgentsInjectionLocationUpdateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaManagedAgentsInjectionLocationUpdateParams
        {
            Body = true,
            Header = true,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<BetaManagedAgentsInjectionLocationUpdateParams>(
                json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaManagedAgentsInjectionLocationUpdateParams copied = new(model);
