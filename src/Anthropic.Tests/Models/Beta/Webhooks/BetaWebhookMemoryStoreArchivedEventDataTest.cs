...
public class BetaWebhookMemoryStoreArchivedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookMemoryStoreArchivedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("memory_store.archived");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaWebhookMemoryStoreArchivedEventData>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookMemoryStoreArchivedEventData copied = new(model);
