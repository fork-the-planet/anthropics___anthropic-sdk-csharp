...
public class BetaWebhookAgentDeletedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookAgentDeletedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("agent.deleted");
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookAgentDeletedEventData copied = new(model);
