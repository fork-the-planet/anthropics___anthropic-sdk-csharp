...
public class BetaWebhookDeploymentUnpausedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookDeploymentUnpausedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("deployment.unpaused");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaWebhookDeploymentUnpausedEventData>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookDeploymentUnpausedEventData copied = new(model);
