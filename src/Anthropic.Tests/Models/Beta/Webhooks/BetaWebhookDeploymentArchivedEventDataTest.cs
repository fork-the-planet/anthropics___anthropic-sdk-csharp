...
public class BetaWebhookDeploymentArchivedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookDeploymentArchivedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("deployment.archived");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaWebhookDeploymentArchivedEventData>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookDeploymentArchivedEventData copied = new(model);
