...
public class BetaWebhookEnvironmentUpdatedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookEnvironmentUpdatedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("environment.updated");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaWebhookEnvironmentUpdatedEventData>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookEnvironmentUpdatedEventData copied = new(model);
