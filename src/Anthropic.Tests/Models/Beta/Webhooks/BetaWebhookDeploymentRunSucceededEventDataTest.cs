...
public class BetaWebhookDeploymentRunSucceededEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookDeploymentRunSucceededEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("deployment_run.succeeded");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaWebhookDeploymentRunSucceededEventData>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookDeploymentRunSucceededEventData copied = new(model);
