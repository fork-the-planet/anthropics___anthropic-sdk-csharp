...
public class BetaWebhookDeploymentRunStartedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookDeploymentRunStartedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("deployment_run.started");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaWebhookDeploymentRunStartedEventData>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookDeploymentRunStartedEventData copied = new(model);
