...
public class BetaWebhookAgentUpdatedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookAgentUpdatedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("agent.updated");
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookAgentUpdatedEventData copied = new(model);
